    ...
    prompt_messages = [
        {
            ...
            "content": (
                ...
                f"Coordonnées officielles d'Orchid Island Real Estate :\n{ORCHID_CONTACT}\n"
                "N'inclus ces coordonnées QUE si l'utilisateur demande explicitement comment contacter "
                "l'agence, son numéro, son adresse ou son site. Ne les ajoute jamais en fin de message par "
                "défaut ni comme formule de politesse — la plupart des réponses n'en ont pas besoin. "
