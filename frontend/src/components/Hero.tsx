    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center lg:text-left">
        <div className="max-w-4xl mx-auto lg:mx-0">
          ...
          {/* Main Heading */}
          <h1 className="notranslate font-playfair text-5xl md:text-6xl lg:text-7xl font-bold text-ivory-white mb-6 leading-tight" translate="no" >
            Orchid Island<br />
            <span className="notranslate luxury-gradient bg-clip-text text-transparent" translate="no">Real estate</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-6 mb-10 text-ivory-white/80 font-lora">
            <div className="flex items-center space-x-2">
              ...
              <span>Exclusive property sales</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-1 h-1 luxury-gradient rounded-full"></div>
              <span>Custom acquisition</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-1 h-1 luxury-gradient rounded-full"></div>
              <span>High-end rental</span>
            </div>
          </div>
